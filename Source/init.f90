...
ALLOCATE(M%RTE_COR(0:IBP1,0:JBP1,0:KBP1),STAT=IZERO) ; CALL ChkMemErr('INIT','RTE_COR',IZERO)

DO K=0,KBP1
   DO J=0,JBP1
      DO I=0,IBP1
         M%RTE_COR(I,J,K) = 1._EB
      ENDDO
   ENDDO
ENDDO
...
CALL GET_N_LAYER_CELLS(SF%MIN_DIFFUSIVITY(1),SF%SWELL_RATIO*ONE_D%LAYER_THICKNESS(1),SF%STRETCH_FACTOR(1), &
                       SF%CELL_SIZE_FACTOR(1),SF%CELL_SIZE,SF%N_LAYER_CELLS_MAX(1),ONE_D%N_CELLS_MAX,&
...
CALL GET_N_LAYER_CELLS(SF%MIN_DIFFUSIVITY(1),ONE_D%LAYER_THICKNESS(1),SF%STRETCH_FACTOR(1), &
                       SF%CELL_SIZE_FACTOR(1),SF%CELL_SIZE,SF%N_LAYER_CELLS_MAX(1),ONE_D%N_LAYER_CELLS(1),&
                       ONE_D%SMALLEST_CELL_SIZE(1),ONE_D%DDSUM(1))
