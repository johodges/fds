...
! VTKHDF output clocks.  These have no RAMP of their own; DT_*_VTK is derived from either
! DT_VTK or the matching Smokeview interval in READ_DUMP.

CALL SET_OUTPUT_CLOCK(DT_SLCF_VTK,0,SLCF_VTK_CLOCK,SLCF_VTK_COUNTER,.TRUE. ,.TRUE. )
CALL SET_OUTPUT_CLOCK(DT_SL3D_VTK,0,SL3D_VTK_CLOCK,SL3D_VTK_COUNTER,.TRUE. ,.TRUE. )
CALL SET_OUTPUT_CLOCK(DT_SM3D_VTK,0,SM3D_VTK_CLOCK,SM3D_VTK_COUNTER,.TRUE. ,.TRUE. )
CALL SET_OUTPUT_CLOCK(DT_BNDF_VTK,0,BNDF_VTK_CLOCK,BNDF_VTK_COUNTER,.TRUE. ,.TRUE. )
CALL SET_OUTPUT_CLOCK(DT_PART_VTK,0,PART_VTK_CLOCK,PART_VTK_COUNTER,.TRUE. ,.TRUE. )
