...
USE GLOBAL_CONSTANTS, ONLY: N_TOTAL_SCALARS,N_SURFACE_DENSITY_SPECIES
...
USE GLOBAL_CONSTANTS, ONLY: SIGMA,TMPA,RHOA,TMPA4,N_TOTAL_SCALARS, RADIATION
...
B1%ZZ_F(1:N_TOTAL_SCALARS) = SPECIES_MIXTURE(1:N_TOTAL_SCALARS)%ZZ0
B1%ZZ_G(1:N_TOTAL_SCALARS) = SPECIES_MIXTURE(1:N_TOTAL_SCALARS)%ZZ0
B1%RHO_D_F = 0._EB
...
I1 = I2+1 ; I2 = I1 + N_TOTAL_SCALARS - 1
