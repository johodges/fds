...
I1 = RC+1 ; RC = I1 + ONE_D%N_CELLS_MAX + 1
IF (.NOT.COUNT_ONLY) CALL EQUATE(OS%REALS(I1:RC) , ONE_D%K_S_X(0:RC-I1) , UNPACK_IT)

I1 = RC+1 ; RC = I1 + ONE_D%N_CELLS_MAX + 1
IF (.NOT.COUNT_ONLY) CALL EQUATE(OS%REALS(I1:RC) , ONE_D%K_S_Y(0:RC-I1) , UNPACK_IT)

I1 = RC+1 ; RC = I1 + ONE_D%N_CELLS_MAX + 1
IF (.NOT.COUNT_ONLY) CALL EQUATE(OS%REALS(I1:RC) , ONE_D%K_S_Z(0:RC-I1) , UNPACK_IT)
...
IF (ALLOCATED(ONE_D%K_S_X)) DEALLOCATE(ONE_D%K_S_X)                           ; ALLOCATE(ONE_D%K_S_X(0:ONE_D%N_CELLS_MAX+1))
IF (ALLOCATED(ONE_D%K_S_Y)) DEALLOCATE(ONE_D%K_S_Y)                           ; ALLOCATE(ONE_D%K_S_Y(0:ONE_D%N_CELLS_MAX+1))
IF (ALLOCATED(ONE_D%K_S_Z)) DEALLOCATE(ONE_D%K_S_Z)                           ; ALLOCATE(ONE_D%K_S_Z(0:ONE_D%N_CELLS_MAX+1))
