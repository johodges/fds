...
TYPE MESH_TYPE
   ...
   INTEGER :: NP=0, NC=0   !< Number of points and cells in the mesh, used by the VTKHDF writers
   ...
   ! Slices grouped by the plane they lie on, for the VTKHDF slice files
...
INTEGER, POINTER :: N_SLCF, N_SLCF_O, N_UNIQUE_SLCF
