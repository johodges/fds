...
TYPE MESH_TYPE
   ...
   REAL(EB), ALLOCATABLE, DIMENSION(:,:,:) :: RTE_COR     !< RTE corrective factor
...
REAL(EB), POINTER, DIMENSION(:,:,:) :: &
   ...
   CSD2,MTR,MSR,WEM,MIX_TIME,CHEM_SUBIT,STRAIN_RATE,D_Z_MAX,Q_DOT_PPP_S,PP_RESIDUAL,LES_FILTER_WIDTH,RTE_COR, &
