...
#ifdef WITH_HDF5
PUBLIC CREATE_OPEN_VTKHDF,OPEN_VTKHDF,CLOSE_VTKHDF,&
       OPEN_VTKHDF_SLICE,CLOSE_VTKHDF_SLICE,INITIALIZE_VTKHDF_SLICE,EXTEND_SLICE_VTKHDF,ADD_DATA_TO_SLICE_VTKHDF,&
       BUILD_VTK_SLICE_GEOMETRY,WRITE_VTKHDF_SLICE_CELL_FILE,DEALLOCATE_VTK_GAS_PHASE_GEOMETRY,&
       OPEN_VTKHDF_SMOKE3D,CLOSE_VTKHDF_SMOKE3D,INITIALIZE_VTKHDF_SMOKE3D,EXTEND_SMOKE3D_VTKHDF,ADD_DATA_TO_SMOKE3D_VTKHDF,&
       OPEN_VTKHDF_BNDF,CLOSE_VTKHDF_BNDF,INITIALIZE_VTKHDF_BNDF,BUILD_VTK_SOLID_PHASE_GEOMETRY,EXTEND_BNDF_VTKHDF,&
       CREATE_OPEN_PART_VTKHDF,CLOSE_PART_VTKHDF,&
       PARALLEL_INIT_I32,PARALLEL_WRITE_I32,APPEND_RANK1_DATASET_I32,&
       PARALLEL_INIT_F32,PARALLEL_WRITE_F32,APPEND_RANK1_DATASET_F32,&
       PARALLEL_INIT_U8,PARALLEL_WRITE_U8,&
       ADD_ATTRIBUTE_INT,CREATE_OPEN_VTKHDF_SERIES,&
       BUILD_VTK_GAS_PHASE_GEOMETRY,BUILD_VTK_GEOM_GEOMETRY,WRITE_VTKHDF_GEOM_FILE
#endif
...
SUBROUTINE INITIALIZE_VTKHDF_SLICE(FILENAME,SLCFNAME,II,NTSL)
   ...
   MESH_LOOP2: DO NM=1,NMESHES
      ...
      CALL WRITE_VTKHDF_SLICE_CELL_FILE(SLCFNAME,SL3D,NM,NCELLS_ALL,NPOINTS_ALL,NCONNECTIONS_ALL,NTSL,&
...
SUBROUTINE ADD_DATA_TO_SLICE_VTKHDF(DATASET,NM,NCELLS,NPOINTS,DATA,&
   ...
   END SUBROUTINE ADD_DATA_TO_SLICE_VTKHDF

SUBROUTINE BUILD_VTK_SLICE_GEOMETRY(NM, SL, NTSL, &
...
SUBROUTINE WRITE_VTKHDF_SLICE_CELL_FILE(SLCFNAME,SL3D,NM,NCELLS,NPOINTS,NCONNECTIONS,NTSL,&
   ...
   MESH_LOOP_HDF: DO NMNM=1,NMESHES
      ...
      ELSE
         QUANTITY_LOOPB: DO IQ=1,NQT
            ...
            CALL BUILD_VTK_SLICE_GEOMETRY(NMNM, SL, NTSL, NC, NP, VERTICES, CONNECT, OFFSETS, VTKC_TYPE)
            EXIT
...
SUBROUTINE INITIALIZE_VTKHDF_SMOKE3D()
   ...
   MESH_LOOP_HDF: DO NM=1,NMESHES
      ...
      N_WRITTEN = N_WRITTEN+1
      M => MESHES(NM)
      CALL BUILD_VTK_GAS_PHASE_GEOMETRY(NM, NCELLS, NPOINTS, VERTICES, CONNECT, OFFSETS, VTKC_TYPE)
...
SUBROUTINE ADD_DATA_TO_SMOKE3D_VTKHDF(DATANAME,DATA,NM_IN,BASE_OFFSET,FAKE_WRITE)
   CHARACTER(*), INTENT(IN) :: DATANAME
...
END SUBROUTINE ADD_DATA_TO_SMOKE3D_VTKHDF
