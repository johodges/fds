...
SUBROUTINE EXTEND_SLICE_VTKHDF(DATANAME, II, BASE_OFFSET, NCELLS, NPOINTS)
   ...
   CALL PARALLEL_INIT_F32(HDF_SLCF_G4(II), TRIM(DATANAME), HDF_SLCF_CRP_LIST(II), 1,&
      NPOINTS_MAX_ARRAY, (/0_HSIZE_T/), DSET_ID, HDF_SLCF_PLIST_ID(II), MDIM)
...
SUBROUTINE WRITE_VTKHDF_RECT_GAS_FILE_KEEPOPEN(FILENAME,&
   ...
   MESH_LOOP_HDF: DO NM=1,NMESHES
      ...
      EXTENT1 = 1
      IDATA_OUT1 = NCELLS
      CALL PARALLEL_WRITE_I32(1, DSET_ID_NCELLS, PLIST_ID, START1, EXTENT1, IDATA_OUT1)
      
      ! Write number of points data to file
      IDATA_OUT1 = NPOINTS
      CALL PARALLEL_WRITE_I32(1, DSET_ID_NPTS, PLIST_ID, START1, EXTENT1, IDATA_OUT1)
      
      ! Write NumberOfConnectivityIds data to file
      IDATA_OUT1 = NCELLS*8
      CALL PARALLEL_WRITE_I32(1, DSET_ID_NCON, PLIST_ID, START1, EXTENT1, IDATA_OUT1)
      
      ! Write offsets data to file
      START1 = NOFFSETS_ACCUM
      EXTENT1 = NCELLS+1
      CALL PARALLEL_WRITE_I32(1, DSET_ID_OFF, PLIST_ID, START1, EXTENT1, OFFSETS)
   ...
   DO NM=1,MAXVAL(MESHES_PER_PROCESS)
      IF (N_WRITTEN < MAXVAL(MESHES_PER_PROCESS)) THEN
         ...
         EXTENT2(1:2) = INT((/3, NPOINTS/),HSIZE_T)
         RDATA_OUT3 = 0._FB
         CALL PARALLEL_WRITE_F32(2, DSET_ID_PTS, PLIST_ID, START2, EXTENT2, RDATA_OUT3)
   ...
   IF (WRITE_VTK_GEOM_PER_TIMESTEP) THEN
      ...
      DO NM=1,MAXVAL(MESHES_PER_PROCESS)*2
         IF (N_WRITTEN < MAXVAL(MESHES_PER_PROCESS)*2) THEN
            ...
            EXTENT1 = 0
            IDATA_OUT1 = 0
            CALL PARALLEL_WRITE_I32(1, DSET_ID_CON, PLIST_ID, START1, EXTENT1, IDATA_OUT1)
            
            ! Write offsets data to file
            CALL PARALLEL_WRITE_I32(1, DSET_ID_OFF, PLIST_ID, START1, EXTENT1, IDATA_OUT1)
            ...
            ! Write types data to file
            DATA_OUT1_U8 = 0
            CALL PARALLEL_WRITE_U8(1, DSET_ID_TYP, PLIST_ID, START1, EXTENT1, DATA_OUT1_U8)
            N_WRITTEN = N_WRITTEN + 1
         ENDIF
      ENDDO
...
SUBROUTINE TEST_VTKHDF_EXTEND(SNAME,G5,DSET_ID,PLIST_ID)
  ...
  CALL APPEND_RANK1_DATASET_F32(DSET_ID,PLIST_ID,REAL((/data1(1)/)),1)
  !CALL APPEND_RANK1_DATASET_F32(DSET_ID,PLIST_ID,REAL((/data1(2),data1(3)/)),2)
  !CALL APPEND_RANK1_DATASET_F32(DSET_ID,PLIST_ID,REAL((/5/)),1)
  !CALL APPEND_RANK1_DATASET_F32(DSET_ID,PLIST_ID,REAL((/6,7,8/)),3)
