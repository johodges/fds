...
PUBLIC WRITE_VTKHDF_GEOM_FILE,&
       ...
       INITIALIZE_VTKHDF_SLCF_KEEPOPEN,INITIALIZE_VTKHDF_SMOKE3D,&
       ADD_DATA_TO_SMOKE3D_VTKHDF_FILE_NOOPEN,INITIALIZE_VTKHDF_BNDF,&
       CREATE_OPEN_PART_VTKHDF,CLOSE_VTKHDF_SERIES,CLOSE_VTKHDF_SMOKE3D,&
       APPEND_RANK1_DATASET_I32,APPEND_RANK1_DATASET_F32,&
       TEST_VTKHDF_EXTEND,OPEN_VTKHDF_SERIES,&
       OPEN_VTKHDF_SMOKE3D,EXTEND_SMOKE3D_VTKHDF,ADD_ATTRIBUTE_INT
#endif
...
SUBROUTINE CREATE_OPEN_PART_VTKHDF(FILENAME,&
   ...
   CALL ADD_ATTRIBUTE_CHAR(GROUP_ID1,DATA_DIMS,"Type","PolyData",8_SIZE_T)
...
SUBROUTINE EXTEND_SMOKE3D_VTKHDF(DATANAME, BASE_OFFSET)
   ...
   CALL PARALLEL_INIT_U8(HDF_SM3D_G4, TRIM(DATANAME), HDF_SM3D_CRP_LIST, 1,&
      NPOINTS_MAX_ARRAY, (/0_HSIZE_T/), DSET_ID, HDF_SM3D_PLIST_ID, MDIM) ! Values = Timesteps
...
SUBROUTINE ADD_DATA_TO_SMOKE3D_VTKHDF_FILE_NOOPEN(DATANAME,DATA,NM_IN,BASE_OFFSET,FAKE_WRITE)
   CHARACTER(*), INTENT(IN) :: DATANAME
   ...
   MESH_LOOP_HDF: DO NM=1,NMESHES
      ...
      IF (.NOT.FAKE_WRITE) THEN
         ...
         CALL PARALLEL_WRITE_U8(1, NPOINTS_TOTAL_ARRAY, DSET_ID,&
            HDF_SM3D_PLIST_ID, NPOINTS_MAX_ARRAY+BASE_OFFSET, NPOINTS_TOTAL_ARRAY, DATA)
      ELSE
   ...
   ! Close HDF5 datasets
   CALL H5DCLOSE_F(DSET_ID, ERROR)
   CALL H5PCLOSE_F(HDF_SM3D_PLIST_ID, ERROR)
...
SUBROUTINE INITIALIZE_VTKHDF_SMOKE3D(FILENAME)
   CHARACTER(*), INTENT(IN) :: FILENAME
   INTEGER(HID_T) :: CRP_LIST       ! Identifiers
   INTEGER(HID_T) :: DSET_ID_CON, DSET_ID_NCELLS, DSET_ID_NCON    ! Dataset identifiers
   INTEGER(HID_T) :: DSET_ID_NPTS, DSET_ID_OFF, DSET_ID_PTS, DSET_ID_TYP       ! Dataset identifiers
   INTEGER(HID_T) :: DSET_ID_CONN_OFF
   INTEGER :: NPOINTS_TOTAL, NCELLS_TOTAL, NOFFSETS_TOTAL
   INTEGER :: NPOINTS, NCELLS
   INTEGER :: NCONN_TOTAL, NPIECES
   INTEGER :: NOFFSETS_ACCUM, NCONN_ACCUM, NPIECES_ACCUM, NCELLS_ACCUM, NPOINTS_ACCUM !, NFACES
   ...
   START1 = NCONN_MAX
   EXTENT1 = NCONN_TOTAL
   CALL PARALLEL_INIT_I32(HDF_SM3D_G1, TRIM("Connectivity"), CRP_LIST, 1, START1, EXTENT1, DSET_ID_CON, HDF_SM3D_PLIST_ID) ! Connectivity
   START1 = NPIECES
   EXTENT1 = NPIECES
   CALL PARALLEL_INIT_I32(HDF_SM3D_G1, TRIM("NumberOfCells"), CRP_LIST, 1, START1, EXTENT1, DSET_ID_NCELLS, HDF_SM3D_PLIST_ID) ! NumberOfCells
   CALL PARALLEL_INIT_I32(HDF_SM3D_G1, TRIM("NumberOfPoints"), CRP_LIST, 1, START1, EXTENT1, DSET_ID_NPTS, HDF_SM3D_PLIST_ID) ! NumberOfPoints
   CALL PARALLEL_INIT_I32(HDF_SM3D_G1, TRIM("NumberOfConnectivityIds"), CRP_LIST, 1, START1, EXTENT1, DSET_ID_NCON,&
      HDF_SM3D_PLIST_ID) ! NumberOfConnectivityIds
   START1 = NOFFSETS_MAX
   EXTENT1 = NOFFSETS_TOTAL
   CALL PARALLEL_INIT_I32(HDF_SM3D_G1, TRIM("Offsets"), CRP_LIST, 1, START1, EXTENT1, DSET_ID_OFF, HDF_SM3D_PLIST_ID) ! Offsets
   START2(1:2) = INT((/3, NPOINTS_MAX/),HSIZE_T)
   EXTENT2(1:2) = INT((/3, NPOINTS_TOTAL/),HSIZE_T)
   CALL PARALLEL_INIT_F32(HDF_SM3D_G1, TRIM("Points"), CRP_LIST, 2, START2,EXTENT2, DSET_ID_PTS, HDF_SM3D_PLIST_ID) ! Points
   START1 = NCELLS_MAX
   EXTENT1 = NCELLS_TOTAL
   CALL PARALLEL_INIT_U8(HDF_SM3D_G1, TRIM("Types"), CRP_LIST, 1, START1, EXTENT1, DSET_ID_TYP, HDF_SM3D_PLIST_ID) ! Types
   ...
   MESH_LOOP_HDF: DO NM=1,NMESHES
      ...
      START1 = NCELLS_ACCUM*8
      EXTENT1 = NCELLS*8
      CALL PARALLEL_WRITE_I32(1, EXTENT1, DSET_ID_CON, HDF_SM3D_PLIST_ID, START1, EXTENT1, CONNECT)
      
      ! Write number of cells data to file
      START1 = NM-1
      EXTENT1 = 1
      IDATA_OUT1 = NCELLS
      CALL PARALLEL_WRITE_I32(1, EXTENT1, DSET_ID_NCELLS, HDF_SM3D_PLIST_ID, START1, EXTENT1, IDATA_OUT1)
      
      ! Write number of points data to file
      IDATA_OUT1 = NPOINTS
      CALL PARALLEL_WRITE_I32(1, EXTENT1, DSET_ID_NPTS, HDF_SM3D_PLIST_ID, START1, EXTENT1, IDATA_OUT1)
      
      ! Write NumberOfConnectivityIds data to file
      IDATA_OUT1 = NCELLS*8
      CALL PARALLEL_WRITE_I32(1, EXTENT1, DSET_ID_NCON, HDF_SM3D_PLIST_ID, START1, EXTENT1, IDATA_OUT1)
      
      ! Write offsets data to file
      START1 = NOFFSETS_ACCUM
      EXTENT1 = NCELLS+1
      CALL PARALLEL_WRITE_I32(1, EXTENT1, DSET_ID_OFF, HDF_SM3D_PLIST_ID, START1, EXTENT1, OFFSETS)
      
      ! Write point data to file
      START2(1:2) = INT((/0, NPOINTS_ACCUM/),HSIZE_T)
      EXTENT2(1:2) = INT((/3, NPOINTS/),HSIZE_T)
      CALL PARALLEL_WRITE_F32(2, EXTENT2, DSET_ID_PTS, HDF_SM3D_PLIST_ID, START2, EXTENT2, VERTICES)
      
      ! Write types data to file
      START1 = NCELLS_ACCUM
      EXTENT1 = NCELLS
      CALL PARALLEL_WRITE_U8(1, EXTENT1, DSET_ID_TYP, HDF_SM3D_PLIST_ID, START1, EXTENT1, VTKC_TYPE)
   ...
   DO NM=1,MAXVAL(MESHES_PER_PROCESS)
      IF (N_WRITTEN < MAXVAL(MESHES_PER_PROCESS)) THEN
         ...
         EXTENT2(1:2) = INT((/3, NPOINTS/),HSIZE_T)
         RDATA_OUT3 = 0._FB
         CALL PARALLEL_WRITE_F32(2, EXTENT2, DSET_ID_PTS, HDF_SM3D_PLIST_ID, START2, EXTENT2, RDATA_OUT3)
   ...
   !START1 = 0
   !EXTENT1 = NFRAMES
   !ALLOCATE(OFFSETS(NFRAMES))
   !OFFSETS = 0
   
   ! connectivity offsets
   !CALL PARALLEL_INIT_I32(HDF_SM3D_G5, TRIM("ConnectivityIdOffsets"), CRP_LIST, 1, EXTENT1, EXTENT1,&
   !   DSET_ID_CONN_OFF, HDF_SM3D_PLIST_ID) ! Offsets
   !CALL PARALLEL_WRITE_I32(1, EXTENT1, DSET_ID_CONN_OFF, HDF_SM3D_PLIST_ID, START1, EXTENT1, OFFSETS)
   !CALL H5DCLOSE_F(DSET_ID_CONN_OFF, ERROR)
   
   ! cell offsets
   !CALL PARALLEL_INIT_I32(HDF_SM3D_G5, TRIM("CellOffsets"), CRP_LIST, 1, EXTENT1, EXTENT1,&
   !   DSET_ID_CONN_OFF, HDF_SM3D_PLIST_ID) ! Offsets
   !CALL PARALLEL_WRITE_I32(1, EXTENT1, DSET_ID_CONN_OFF, HDF_SM3D_PLIST_ID, START1, EXTENT1, OFFSETS)
   !CALL H5DCLOSE_F(DSET_ID_CONN_OFF, ERROR)
   
   ! part offsets
   !CALL PARALLEL_INIT_I32(HDF_SM3D_G5, TRIM("PartOffsets"), CRP_LIST, 1, EXTENT1, EXTENT1,&
   !   DSET_ID_CONN_OFF, HDF_SM3D_PLIST_ID) ! Offsets
   !CALL PARALLEL_WRITE_I32(1, EXTENT1, DSET_ID_CONN_OFF, HDF_SM3D_PLIST_ID, START1, EXTENT1, OFFSETS)
   !CALL H5DCLOSE_F(DSET_ID_CONN_OFF, ERROR)
   ...
   ! part offsets
   !OFFSETS = NMESHES
   !CALL PARALLEL_INIT_I32(HDF_SM3D_G5, TRIM("NumberOfParts"), CRP_LIST, 1, EXTENT1, EXTENT1,&
   !   DSET_ID_CONN_OFF, HDF_SM3D_PLIST_ID) ! Offsets
   !CALL PARALLEL_WRITE_I32(1, EXTENT1, DSET_ID_CONN_OFF, HDF_SM3D_PLIST_ID, START1, EXTENT1, OFFSETS)
   !CALL H5DCLOSE_F(DSET_ID_CONN_OFF, ERROR)
   ...
   !   CALL PARALLEL_INIT_I32(HDF_SM3D_G6, TRIM(S3%SMOKEVIEW_LABEL(1:30)), CRP_LIST, 1, EXTENT1, EXTENT1,&
   !      DSET_ID_CONN_OFF, HDF_SM3D_PLIST_ID) ! Offsets
   !   CALL PARALLEL_WRITE_I32(1, EXTENT1, DSET_ID_CONN_OFF, HDF_SM3D_PLIST_ID, START1, EXTENT1, OFFSETS)
   !   CALL H5DCLOSE_F(DSET_ID_CONN_OFF, ERROR)
   !ENDDO DATA_FILE_LOOP
   
   ! write time step to values
   !EXTENT1 = 0
   !CALL PARALLEL_INIT_I32(HDF_SM3D_G5, TRIM("Values"), HDF_SM3D_CRP_LIST, 1, (/1_HSIZE_T/), (/0_HSIZE_T/),&
   !   DSET_ID_CONN_OFF, HDF_SM3D_PLIST_ID,(/H5S_UNLIMITED_F/)) ! Values = Timesteps
   !CALL PARALLEL_WRITE_I32(1, EXTENT1, DSET_ID_CONN_OFF, HDF_SM3D_PLIST_ID, START1, EXTENT1, OFFSETS)
   !CALL H5DCLOSE_F(DSET_ID_CONN_OFF, ERROR)
...
SUBROUTINE OPEN_VTKHDF_SMOKE3D(FILENAME)
...
SUBROUTINE TEST_VTKHDF_EXTEND(SNAME,G5,DSET_ID,PLIST_ID)
  !
  ...
  INTEGER(HID_T) :: G1,G2,G3,G4,G5,G6,G7

  !
  !dataset dimensions at creation time
  !
  INTEGER(HSIZE_T), DIMENSION(1) :: CDIM = (/3/)
  INTEGER(HSIZE_T), DIMENSION(1) :: CDIM2, MDIM2
  !
  !data dimensions 
  !
  INTEGER(HSIZE_T), DIMENSION(1) :: DDIM = (/1/)
  ...
  !
  REAL, DIMENSION(1:3)  :: data1 
  REAL, DIMENSION(1:1) :: data2
  ...
  !
  INTEGER(HSIZE_T), DIMENSION(1) :: size1
  ...
  !  
  INTEGER(HSIZE_T), DIMENSION(1) :: dimsr, maxdimsr
  INTEGER :: rankr
  INTEGER, DIMENSION(1:4)  :: rdata 
  ...
  !
  !CALL h5open_f(error) 
  !CALL CREATE_OPEN_VTKHDF_SERIES(FILENAME,FILE_ID,PLIST_ID,G1,G2,G3,G4,G5,G6,G7)
  ...
  OFFSET = 0
  CDIM = (/0/)
  CALL PARALLEL_INIT_F32(G5, SNAME, CRP_LIST, RANK, DDIM, INT((/0/),HID_T), DSET_ID, PLIST_ID, MDIM)
  
  CALL APPEND_RANK1_DATASET_F32(DSET_ID,CRP_LIST,PLIST_ID,REAL((/data1(1)/)),1)
  !CALL APPEND_RANK1_DATASET_F32(DSET_ID,CRP_LIST,PLIST_ID,REAL((/data1(2),data1(3)/)),2)
  !CALL APPEND_RANK1_DATASET_F32(DSET_ID,CRP_LIST,PLIST_ID,REAL((/5/)),1)
  !CALL APPEND_RANK1_DATASET_F32(DSET_ID,CRP_LIST,PLIST_ID,REAL((/6,7,8/)),3)
  
  WRITE(*,'(A)') "Dataset after write:" 
  CALL H5DGET_SPACE_F(DSET_ID, DATASPACE, ERROR)
  CALL H5SGET_SIMPLE_EXTENT_DIMS_F(DATASPACE, CDIM2, MDIM2, ERROR)
  ALLOCATE(DATA_READ(CDIM2(1)))
  CALL H5DREAD_F(DSET_ID, H5T_IEEE_F32LE, DATA_READ, CDIM2, ERROR)
...
END SUBROUTINE TEST_VTKHDF_EXTEND
...
SUBROUTINE TEST_VTKHDF_EXTEND_OLD()
  !USE HDF5 ! This module contains all necessary modules 
  !
  !the dataset is stored in file "extbyrow.h5" 
  !
  CHARACTER(LEN=11), PARAMETER :: FILENAME = "extbyrow.h5"

  !
  !dataset rank is 2 and name is "ExtendibleArray"
  !
  CHARACTER(LEN=15), PARAMETER :: SNAME = "ExtendibleArray"
  INTEGER :: RANK = 1
...
END SUBROUTINE TEST_VTKHDF_EXTEND_OLD
...
SUBROUTINE PARALLEL_INIT_F32(GROUP_ID, SNAME, CRP_LIST, RANK, DDIM, CDIM, DSET_ID, PLIST_ID, MDIM)
...
SUBROUTINE APPEND_RANK1_DATASET_I32(DSET_ID,CRP_LIST,PLIST_ID,INDATA,N)
   ...
   !WRITE(*,*) "COUNT", COUNT
   !WRITE(*,*) "DATA", INDATA
   CALL PARALLEL_WRITE_I32(1, SIZE1, DSET_ID, PLIST_ID, OFFSET, COUNT, INDATA)
END SUBROUTINE APPEND_RANK1_DATASET_I32

SUBROUTINE APPEND_RANK1_DATASET_F32(DSET_ID,CRP_LIST,PLIST_ID,INDATA,N)
   INTEGER, INTENT(IN)     ::   N    ! Dataset rank
   ...
   !WRITE(*,*) "COUNT", COUNT
   !WRITE(*,*) "DATA", INDATA
   CALL PARALLEL_WRITE_F32(1, SIZE1, DSET_ID, PLIST_ID, OFFSET, COUNT, INDATA)
...
WRITE(LU_PARAVIEW,'(A,A)') "sm3dFiles = [indir+sep+rdir+sep+chid+'_SM3D.vtkhdf']"
