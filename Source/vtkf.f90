...
PUBLIC WRITE_VTKHDF_GEOM_FILE,&
       ...
       INITIALIZE_VTKHDF_SLICE,INITIALIZE_VTKHDF_SMOKE3D,&
       ADD_DATA_TO_SMOKE3D_VTKHDF_FILE_NOOPEN,INITIALIZE_VTKHDF_BNDF,&
       CREATE_OPEN_PART_VTKHDF,CLOSE_VTKHDF_SERIES,&
       APPEND_RANK1_DATASET_I32,APPEND_RANK1_DATASET_F32,&
       TEST_VTKHDF_EXTEND,OPEN_VTKHDF_SERIES,&
       OPEN_VTKHDF_SMOKE3D,ADD_ATTRIBUTE_INT,&
       CLOSE_VTKHDF_SMOKE3D,CLOSE_VTKHDF_SLICE,&
       EXTEND_SMOKE3D_VTKHDF,EXTEND_SLICE_VTKHDF
#endif
...
SUBROUTINE EXTEND_SLICE_VTKHDF(DATANAME, II, BASE_OFFSET, NCELLS, NPOINTS)
   ...
   CALL PARALLEL_INIT_F32(HDF_SLCF_G4(II), TRIM(DATANAME), HDF_SLCF_CRP_LIST(II), 1,&
      NPOINTS_MAX_ARRAY, (/0_HSIZE_T/), DSET_ID, HDF_SLCF_PLIST_ID(II), MDIM) ! Values = Timesteps
...
SUBROUTINE INITIALIZE_VTKHDF_SLICE(FILENAME,SLCFNAME,II,NTSL)
   ...
   MESH_LOOP: DO NM=1,NMESHES
      ...
      EXTENT1 = 1
      IDATA_OUT_32 = NCELLS
      CALL PARALLEL_WRITE_I32(1, EXTENT1, DSET_ID_NCELLS, HDF_SLCF_PLIST_ID(II), START1, EXTENT1, IDATA_OUT_32)
      
      ! Write number of points data to file
      START1 = NM-1
      EXTENT1 = 1
      IDATA_OUT_32 = NPOINTS
      CALL PARALLEL_WRITE_I32(1, EXTENT1, DSET_ID_NPTS, HDF_SLCF_PLIST_ID(II), START1, EXTENT1, IDATA_OUT_32)
      
      ! Write NumberOfConnectivityIds data to file
      START1 = NM-1
      EXTENT1 = 1
      IDATA_OUT_32 = NCELLS*NCONNECTIONS
      CALL PARALLEL_WRITE_I32(1, EXTENT1, DSET_ID_NCON, HDF_SLCF_PLIST_ID(II), START1, EXTENT1, IDATA_OUT_32)
...
SUBROUTINE WRITE_VTKHDF_SLICE_DATA_FILE_NOOPEN(DATASET,NM,NCELLS,NPOINTS,DATA,&
   PLIST_ID,CRP_LIST,GROUP_ID4,BASE_OFFSET,FAKE_WRITE)
   ...
   ELSE
      MESH_LOOP_HDF: DO NMNM=1,NMESHES
         ...
         ! Write point data to file
         START1 = NPOINTS_ACCUM+BASE_OFFSET
         EXTENT1 = NPOINTS(NM)
         CALL PARALLEL_WRITE_F32(1, EXTENT1, DSET_ID, PLIST_ID, START1, EXTENT1, DATA)
...
WRITE(LU_PARAVIEW,'(A)') "        slcfTypes = slcfTypes = [x.split(chid+'_'+axis_name+'_')[1].replace('.vtkhdf','') for x in sl2dFiles]"
