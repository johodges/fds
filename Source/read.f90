...
NAMELIST /DUMP/ CFL_FILE,CLIP_RESTART_FILES,COLUMN_DUMP_LIMIT,CTRL_COLUMN_LIMIT,DEVC_COLUMN_LIMIT,&
                ...
                STATUS_FILES,SUPPRESS_DIAGNOSTICS,TURB_INIT_CLOCK,VELOCITY_ERROR_FILE,VTK_BINARY,WRITE_VTK,WRITE_XYZ,WRITE_STL
...
READ_DEVC_LOOP: DO NN=1,N_DEVC_READ
   ...
   IF (QUANTITY=='TIME OF ARRIVAL') AGL_TIMERS(1) = .TRUE.
   IF (QUANTITY=='RESIDENCE TIME')  AGL_TIMERS(2) = .TRUE.
   ...
   SLCF_LOOP: DO NN=1,N_SLCF_O
      ...
      VECTORLOOPNAME: DO ITER=1,NITER
         ...
         CALL GET_QUANTITY_INDEX(SMOKEVIEW_LABEL,SMOKEVIEW_BAR_LABEL,INDEX,INDEX2, &
            Y_INDEX,Z_INDEX,PART_INDEX,I_DUM(1),I_DUM(2),REAC_INDEX,MATL_INDEX,'SLCF', &
            QUANTITY_TMP,QUANTITY2,SPEC_ID,PART_ID,'null','null',REAC_ID,'null',-1._EB,I_DUM(3),&
            SLICETYPE=SLICETYPE)
