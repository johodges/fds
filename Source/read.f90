...
REAL(EB) :: TAU_Q,TAU_V,TAU_T,TAU_MF(MAX_SPECIES),HRRPUA,MLRPUA,TEXTURE_WIDTH,TEXTURE_HEIGHT,VEL_T(2),&
            ...
            STRETCH_FACTOR(MAX_LAYERS),CONVECTION_LENGTH_SCALE,CONVECTION_LENGTH_SCALE2,&
            ...
            NUSSELT_IMP_C0,NUSSELT_IMP_C1,NUSSELT_IMP_C2,NUSSELT_IMP_M,PARTICLE_SURFACE_DENSITY,&
            MOISTURE_FRACTION(MAX_LAYERS),SURFACE_VOLUME_RATIO(MAX_LAYERS),MASS_PER_VOLUME(MAX_LAYERS),SHAPE_FACTOR,&
            SUM_D,REMESH_RATIO,&
            DRAG_COEFFICIENT,MINIMUM_BURNOUT_TIME,DELTA_TMP_MAX,BURN_DURATION,REFERENCE_DENSITY,REFERENCE_JET_TEMPERATURE,&
...
NAMELIST /SURF/ ADIABATIC,ALLOW_SURFACE_PARTICLES,ALLOW_UNDERSIDE_PARTICLES,AREA_MULTIPLIER,BACKING,BLOWING,&
                ...
                CONVECTION_LENGTH_SCALE,CONVECTION_LENGTH_SCALE2,CONVECTIVE_HEAT_FLUX,CONVERT_VOLUME_TO_MASS,DEFAULT,DELTA_TMP_MAX,&
                DRAG_COEFFICIENT,DSC_CONVERSION_FACTOR,DT_INSERT,E_COEFFICIENT,&
                ...
                NUSSELT_IMP_C0,NUSSELT_IMP_C1,NUSSELT_IMP_C2,NUSSELT_IMP_M,&
                ...
                RAMP_V,RAMP_V_X,RAMP_V_Y,RAMP_V_Z,REFERENCE_DENSITY,REFERENCE_JET_TEMPERATURE,&
...
READ_SURF_LOOP: DO N=0,N_SURF
   ...
   IF (CONVECTION_LENGTH_SCALE2 > 0) THEN
      SF%CONV_LENGTH2          = CONVECTION_LENGTH_SCALE2
   ELSE
      SF%CONV_LENGTH2          = CONVECTION_LENGTH_SCALE
   ENDIF
   ...
   SF%NUSSELT_IMP_C0       = NUSSELT_IMP_C0
   SF%NUSSELT_IMP_C1       = NUSSELT_IMP_C1
   SF%NUSSELT_IMP_C2       = NUSSELT_IMP_C2
   SF%NUSSELT_IMP_M        = NUSSELT_IMP_M
...
CONVECTION_LENGTH_SCALE2= -1._EB
...
NUSSELT_C2              = -1._EB
NUSSELT_M               = -1._EB
NUSSELT_IMP_C0          =  0._EB
NUSSELT_IMP_C1          =  0.021_EB
NUSSELT_IMP_C2          =  0._EB
NUSSELT_IMP_M           =  0.8_EB
