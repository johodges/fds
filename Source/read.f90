...
MWR_Z = 1._EB/SPECIES_MIXTURE(1:N_TRACKED_SPECIES)%MW
...
RSQ_MW_Z = 1._EB/SQRT(SPECIES_MIXTURE(1:N_TRACKED_SPECIES)%MW)
...
IF (MIXING_AS_PASSIVE_SCALAR_TRANSPORT) N_PASSIVE_SCALARS = N_PASSIVE_SCALARS + 1
...
REDEFINE_H_F = .FALSE.
LISTED_FUEL = .FALSE.
H_F_OLD = SPECIES_MIXTURE(1:N_TRACKED_SPECIES)%H_F
REAC_LOOP: DO NR=1,N_REACTIONS
