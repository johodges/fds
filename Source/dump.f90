...
INTEGER :: CDIM, SIZE1
INTEGER(HID_T) :: DATASPACE, MEMSPACE ! Dataspace identifier 
INTEGER(HID_T) :: CRP_LIST, DSET_ID       ! Identifiers
INTEGER     ::   ERROR ! Error flag
REAL(FB), DIMENSION(1) :: VTK_T
INTEGER(HSIZE_T), DIMENSION(1) :: MDIM 
REAL(FB), ALLOCATABLE, DIMENSION(:) :: DATA
...
VTK_T = REAL(T,FB)
CALL APPEND_RANK1_DATASET_F32(DSET_ID,HDF_SM3D_CRP_LIST,HDF_SM3D_PLIST_ID,VTK_T,1)
...
CALL APPEND_RANK1_DATASET_I32(DSET_ID,HDF_SM3D_CRP_LIST,HDF_SM3D_PLIST_ID,(/0_IB32/),1)
CALL H5DCLOSE_F(DSET_ID,ERROR)
...
CALL PARALLEL_INIT_I32(HDF_SM3D_G5, TRIM("NumberOfParts"), HDF_SM3D_CRP_LIST, 1,&
   (/1_HSIZE_T/), (/0_HSIZE_T/), DSET_ID, HDF_SM3D_PLIST_ID, (/H5S_UNLIMITED_F/))
CALL APPEND_RANK1_DATASET_I32(DSET_ID,HDF_SM3D_CRP_LIST,HDF_SM3D_PLIST_ID,(/NMESHES/),1)
CALL H5DCLOSE_F(DSET_ID,ERROR)
...
DATA_FILE_LOOP: DO N=1,N_SMOKE3D
   ...
   CALL PARALLEL_INIT_I32(HDF_SM3D_G7, TRIM(S3%SMOKEVIEW_LABEL(1:30)), HDF_SM3D_CRP_LIST, 1,&
      (/1_HSIZE_T/), (/0_HSIZE_T/), DSET_ID, HDF_SM3D_PLIST_ID, (/H5S_UNLIMITED_F/))
   CALL APPEND_RANK1_DATASET_I32(DSET_ID,HDF_SM3D_CRP_LIST,HDF_SM3D_PLIST_ID,INT((/BASE_OFFSET/),IB32),1)
   CALL H5DCLOSE_F(DSET_ID,ERROR)
...
UNIQUE_LOOPF: DO IQ=1,MESHES(1)%N_UNIQUE_SLCF
   ...
   CALL PARALLEL_INIT_F32(HDF_SLCF_G5(IQ), TRIM("Values"), HDF_SLCF_CRP_LIST(IQ), 1, (/1_HSIZE_T/), (/0_HSIZE_T/),&
      ...
      VTK_T = REAL(T,FB)
   CALL APPEND_RANK1_DATASET_F32(DSET_ID,HDF_SLCF_CRP_LIST(IQ),HDF_SLCF_PLIST_ID(IQ),VTK_T,1)
   CALL H5DCLOSE_F(DSET_ID,ERROR)
   ...
   CALL APPEND_RANK1_DATASET_I32(DSET_ID,HDF_SLCF_CRP_LIST(IQ),HDF_SLCF_PLIST_ID(IQ),(/0_IB32/),1)
   CALL H5DCLOSE_F(DSET_ID,ERROR)
   ...
   CALL PARALLEL_INIT_I32(HDF_SLCF_G5(IQ), TRIM("NumberOfParts"), HDF_SLCF_CRP_LIST(IQ), 1,&
      (/1_HSIZE_T/), (/0_HSIZE_T/), DSET_ID, HDF_SLCF_PLIST_ID(IQ), (/H5S_UNLIMITED_F/))
   CALL APPEND_RANK1_DATASET_I32(DSET_ID,HDF_SLCF_CRP_LIST(IQ),HDF_SLCF_PLIST_ID(IQ),(/NMESHES/),1)
   CALL H5DCLOSE_F(DSET_ID,ERROR)
   ...
   ALL_SLCF_LOOP: DO II=1,MESHES(1)%N_SLCF_VTK
      ...
      CALL APPEND_RANK1_DATASET_I32(DSET_ID,HDF_SLCF_CRP_LIST(II),HDF_SLCF_PLIST_ID(II),INT((/BASE_OFFSET_PTS/),IB32),1)
      CALL H5DCLOSE_F(DSET_ID,ERROR)
