...
INTEGER :: II,JJ,IW,IW1,IW2,MESH_NEIGHBOR(6)
...
INTEGER :: I,J,K,HI1,HI2,VI1,VI2,N,NM,IIO,JJO,KKO,NOM,FACE_INDEX
...
MESH_LOOP: DO NM=1,NMESHES
   ...
   IF ((N_BNDF>0 .AND. M%BNDF_DUMP)) THEN
      DO K=1,M%KBAR
         DO J=1,M%JBAR
