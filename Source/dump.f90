...
IND_SELECT: SELECT CASE(IND)
   ...
   CASE(136) ! UNMIXED FRACTION
      IF (MIXING_AS_PASSIVE_SCALAR_TRANSPORT) THEN
         GAS_PHASE_OUTPUT_RES = ZZ(II,JJ,KK,ZETA_INDEX)*EXP(-DT/MIX_TIME(II,JJ,KK))
      ELSE 
         GAS_PHASE_OUTPUT_RES = INITIAL_UNMIXED_FRACTION*EXP(-DT/MIX_TIME(II,JJ,KK))
      ENDIF
      
   CASE(137) ! UNMIXED FRACTION PASSIVE SCALAR
      IF (MIXING_AS_PASSIVE_SCALAR_TRANSPORT) THEN
         GAS_PHASE_OUTPUT_RES = ZZ(II,JJ,KK,ZETA_INDEX)
      ELSE 
         GAS_PHASE_OUTPUT_RES = INITIAL_UNMIXED_FRACTION
      ENDIF
