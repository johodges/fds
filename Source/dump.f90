...
INTEGER :: NF,IND,L,L1,L2,N,N1,N2,IP,NC,I1,I2,J1,J2,K1,K2
INTEGER :: NBF_DEBUG
INTEGER, INTENT(IN) :: NM
...
FILE_LOOP: DO NF=1,N_BNDF
   ...
   PATCH_LOOP: DO IP=1,N_PATCH
      CALL GET_BNDF_PACK(T,NM,NF,IP,PP,PPN)

      ! Write boundary quantity PP at cell corners, PPN to file as necessary
