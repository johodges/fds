...
WALL_CELL_LOOP: DO IW=1,N_EXTERNAL_WALL_CELLS+N_INTERNAL_WALL_CELLS
   ...
   IF (MIXING_AS_PASSIVE_SCALAR_TRANSPORT) THEN
      ...
      MASS_IN = SUM(B1%M_DOT_G_PP_ACTUAL(1:N_TRACKED_SPECIES))
...
METHOD_OF_HEAT_TRANSFER: SELECT CASE(SF%THERMAL_BC_INDEX)
   ...
   CASE (INTERPOLATED_BC) METHOD_OF_HEAT_TRANSFER  ! Only for EXTERNAL_WALL_CELLs
      ...
      SINGLE_SPEC_IF: IF (N_TOTAL_SCALARS > 1) THEN
         ...
         IF (N_PASSIVE_SCALARS > 0) ZZP(BC%II,BC%JJ,BC%KK,N_TRACKED_SPECIES+1:N_TOTAL_SCALARS) = MAX(0._EB,MIN(1._EB,RHO_ZZ_OTHER(1:N_TRACKED_SPECIES+1:N_TOTAL_SCALARS)))
         ...
         ELSE
            ...
            IF (N_PASSIVE_SCALARS > 0) B1%ZZ_F(N_TRACKED_SPECIES+1:N_TOTAL_SCALARS) = MAX(0._EB,MIN(1._EB,RHO_ZZ_F(N_TRACKED_SPECIES+1:N_TOTAL_SCALARS)))
            ZZ_GET(1:N_TRACKED_SPECIES) = B1%ZZ_F(1:N_TRACKED_SPECIES)
            CALL GET_SPECIFIC_GAS_CONSTANT(ZZ_GET,RSUM_F)
