...
SUB_TIMESTEP_LOOP: DO
   ...
   POINT_LOOP3: DO I=1,NWP
      ...
      MATERIAL_LOOP3: DO N=1,ONE_D%N_MATL
         ...
         SELECT CASE(BC%IOR)
            CASE(1,-1)
               ONE_D%K_S(I) = ONE_D%K_S(I) + ONE_D%MATL_COMP(N)%RHO(I)*ML%K_S_X(ITMP)/RHO_ADJUSTED(LAYER_INDEX(I),N)
            CASE(2,-2)
               ONE_D%K_S(I) = ONE_D%K_S(I) + ONE_D%MATL_COMP(N)%RHO(I)*ML%K_S_Y(ITMP)/RHO_ADJUSTED(LAYER_INDEX(I),N)
            CASE(3,-3)
               ONE_D%K_S(I) = ONE_D%K_S(I) + ONE_D%MATL_COMP(N)%RHO(I)*ML%K_S_Z(ITMP)/RHO_ADJUSTED(LAYER_INDEX(I),N)
         ENDSELECT
      ...
      IF (VOLSUM > 0._EB) THEN
         ...
         !      ONE_D%K_S(I) = ONE_D%K_S(I)/VOLSUM
         !   CASE(3,-3)
         !      ONE_D%K_S_I) = ONE_D%K_S(I)/VOLSUM
         !ENDSELECT
