...
INTEGER, PARAMETER :: CLOCK_STOP=14                    !< Flag for STATUS_STOP
...
LOGICAL :: WRITE_VTK_GEOM_PER_TIMESTEP=.FALSE.      !< Flag that indicates if vtk files should contain geometry every timestep
