...
IF (SUPPRESSION .AND. .NOT.EXTINCT) THEN
   SELECT CASE(EXTINCT_MOD)
      ...
      CASE(EXTINCTION_3); 
         ...
         CALL EXTINCT_2(EXTINCT,ZZ_0,ZZ_MIXED,TMP_IN,H_FACTOR)
...
H_MIN = H_CRIT*(1._EB+EXT_MIN_ENTHALPY)
SLOPE = 1/(H_CRIT-H_MIN)
INTERCEPT = -SLOPE*H_MIN
H_FACTOR = H_0*SLOPE + INTERCEPT
!WRITE(*,*) "EXTINCT", EXTINCT, "HFACTOR", H_FACTOR, "H_0", H_0, "H_CRIT", H_CRIT, "M", SLOPE, "B", INTERCEPT
H_FACTOR = MAX(0._EB,MIN(1._EB, H_FACTOR))
IF (H_FACTOR > TWO_EPSILON_EB) THEN 
   EXTINCT = .FALSE.
   !WRITE(*,*) "EXTINCT", EXTINCT, "MIN_H", EXT_MIN_ENTHALPY, "HFACTOR", H_FACTOR, "H_0", H_0,&
   !   "H_CRIT", H_CRIT, "M", SLOPE, "B", INTERCEPT
ENDIF
!IF (.NOT.EXTINCT) THEN
!   H_FACTOR = 1._EB
!ELSE
!   H_FACTOR = H_0/(H_CRIT-H_CRIT*(1._EB+EXT_MIN_ENTHALPY)) + H_CRIT*(1._EB+EXT_MIN_ENTHALPY)
!ENDIF
