...
IF (SUPPRESSION .AND. .NOT.EXTINCT) THEN
   SELECT CASE(EXTINCT_MOD)
      ...
      CASE(EXTINCTION_3); 
         ...
         TMP_IN2 = ((Q_OUT*CHI_R_OUT+KAPPA_GAS(IIC,JJC,KKC))/(4.*KAPPA_GAS(IIC,JJC,KKC)*SIGMA))**0.25_EB !TMP_IN*2 !*RTE_SOURCE_CORRECTION_FACTOR**0.25_EB
         !WRITE(*,*) "TMP_IN", TMP_IN, "TMP_IN2", TMP_IN2, "Q_OUT", Q_OUT, "CHI_R_OUT", CHI_R_OUT, "UII", UII(IIC,JJC,KKC), "KAPPA", KAPPA_GAS(IIC,JJC,KKC)
