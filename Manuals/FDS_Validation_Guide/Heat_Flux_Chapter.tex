...
Figure~\ref{Lattimer_Tilted_Wall_Heat_Flux} displays the predicted vertical profile of heat flux to the tilted wall above a propane fire, compared to the measured values.
...
\label{Lattimer_Tilted_Wall_Heat_Flux}
\end{figure}
